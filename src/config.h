...
//
#define COMMAND_FG             TRUE  /* -fg option, to assign foreground color  */
#define COMMAND_TINT_BG           TRUE  /* -bg option, to assign background tint color  */
#define COMMAND_TR                TRUE /* -tr option, to assign transparency in [0-1] */
...
// #define PROGRAM_ICON           ".config/aNu/icon.png"
...
//#define TAB_LABEL_CUSTOM       "One", "Two", "Three", "Four", "Five", "Six", "Seven", "Eight", "Nine", "Ten", "Eleven", "Twelve", "Thirteen"
...
#define HOTKEY_SCROLL_ONE_PAGE_UP       ALT(GDK_Page_Up)
#define HOTKEY_SCROLL_ONE_PAGE_DOWN     ALT(GDK_Page_Down)
